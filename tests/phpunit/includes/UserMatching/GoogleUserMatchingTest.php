...
class GoogleUserMatchingTest extends MediaWikiTestCase {
	...
	public function testGetUserFromTokenTokenNotAssociated() {
		...
		$this->assertNull( $matchingService->getUserFromToken( self::VALID_TOKEN ) );
	}
	...
	public function testGetUserFromTokenOneEmailLinked() {
		...
		$user = $matchingService->getUserFromToken( self::VALID_TOKEN );
	...
	public function testMatchWithTokenIdAndUser() {
		...
		$this->assertTrue( $matchingService->match( $this->loggedInUser, self::VALID_TOKEN ) );
	}
	...
	public function testUnmatchWithTokenIdAndUser() {
		...
		$this->assertTrue( $matchingService->unmatch( $this->loggedInUser, self::VALID_TOKEN ) );
	}
}
