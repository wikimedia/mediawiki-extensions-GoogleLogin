...
class GoogleLoginHooks {
	...
	public static function onAuthChangeFormFields( array $requests, array $fieldInfo,
		...
		if ( isset( $formDescriptor['googlelogin'] ) ) {
			$formDescriptor['googlelogin']['weight'] = 101;
			$formDescriptor['googlelogin']['flags'] = [];
		}
	}
	 ...
	 *
	 * Add the "Log in with Google" or "Create with Google" button styles module.
	 *
	...
	public static function onBeforePageDisplay( \OutputPage &$out, \Skin &$skin ) {
		...
		$createTitle = SpecialPage::getTitleFor( 'CreateAccount' );
		if ( $title->equals( $loginTitle ) || $title->equals( $createTitle ) ) {
