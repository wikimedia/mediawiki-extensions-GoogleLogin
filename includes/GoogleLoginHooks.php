...
class GoogleLoginHooks {
	 ...
	 * @param array $extInfo information about the extension
	 * @param SettingsBuilder $sb an instance of SettingsBuilder
	 */
	public static function onSetup( array $extInfo, SettingsBuilder $sb ) {
